...
public class OrderServiceTests {
    ...
    @Test
    public void findByIdShouldThrowForbiddenExceptionWhenOrderIdExistsAndOtherClientLogged(){
    ...
    @Test
    public void findByIdShouldThrowReturnResourceNotFoundExceptionWhenOrderIdDoesNotExist(){
        Mockito.doNothing().when(authService).validateSelfOrAdmin(any());
